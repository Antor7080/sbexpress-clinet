...
import UpdateRechargeModal from "./UpdateRechargeModal";

const RejectedRecharge = () => {
  ...
  useEffect(() => {
    setLoading(true)
    fetch(`https://backend.sbexpressbd.com/recharge/recharges?status=Rejected&page=${page}&email=${userData.email}`, config)
      .then(res => res.json())
      .then(data => {
              ...
              <div class="col-md-12 mb-3">
                ...
                />
                {
                  loading ? <div className="text-center">
                    ...
                    <UpdateRechargeModal data={data1} ></UpdateRechargeModal>
...
export default RejectedRecharge;
