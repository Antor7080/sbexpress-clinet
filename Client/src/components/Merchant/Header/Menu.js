...
import user from "../../img/user1-128x128.jpg";
          ...
          <nav className="mt-2">
            ...
            >
              ...
              <li className="nav-item has-treeview ">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <Link to="/admin/add-balance" className="nav-link">
                      <i className="far fa-circle nav-icon" />
                      <p>Add Balance</p>
                    </Link>
                  </li>
              ...
              <li className="nav-item has-treeview">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <Link to="/admin/add-recharge" className="nav-link">
                      <i className="far fa-circle nav-icon" />
                      <p>Add Recharge</p>
                    </Link>
                  </li>
              ...
              <li className="nav-item has-treeview">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <Link to="/admin/add-mobile-banking" className="nav-link">
                      <i className="far fa-circle nav-icon" />
              ...
              <li className="nav-item has-treeview">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <Link to="/admin/add-sim-purchase" className="nav-link">
                      <i className="far fa-circle nav-icon" />
                      <p>Add New Sim</p>
                    </Link>
                  </li>
              ...
              <li className="nav-item has-treeview">
                ...
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <Link to="/admin/add-direct-bank" className="nav-link">
                      <i className="far fa-circle nav-icon" />
