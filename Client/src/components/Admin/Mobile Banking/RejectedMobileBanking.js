...
import EditMobileBankingModal from "./EditMobileBankingModal";


const RejectedMobileBanking = () => {
      ...
      <div className="content-wrapper">
        <section className="content">
          <div className="container-fluid pt-3">
            <h3>Rejected Mobile Banking Request</h3>
            <hr />
            {
              loading ? <div className="text-center">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <div class=" card table-responsive">
                    ...
                    <EditMobileBankingModal call={call} setCall={setCall} data={data1}></EditMobileBankingModal>
...
export default RejectedMobileBanking;
