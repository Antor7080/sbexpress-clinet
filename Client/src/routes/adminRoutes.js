...
/* import AddRecharge from '../components/Admin/Recharge/AddRecharge';
import AddMobileBanking from '../components/Admin/Mobile Banking/AddMobileBanking';
import AddSimPurchase from '../components/Admin/Sim Purchase/AddSimPurchase';
import AddDirectBank from '../components/Admin/Direct Bank/AddDirectBank'; */
...
/* import AddBalance from '../components/Admin/Balance/AddBalance'; */
...
const adminRoutes = [
    ...
    /*  { path: '/admin/add-recharge', exact: true, name: 'AddRecharge', component: AddRecharge }, */
    /*   { path: '/admin/add-mobile-banking', exact: true, name: 'AddMobileBanking', component: AddMobileBanking }, */
    ...
    /* { path: '/admin/add-balance', exact: true, name: 'AddBalance', component: AddBalance }, */
    ...
    /*   { path: '/admin/add-sim-purchase', exact: true, name: 'AddSimPurchase', component: AddSimPurchase }, */
    ...
    /*   { path: '/admin/add-direct-bank', exact: true, name: 'AddDirectBank', component: AddDirectBank }, */
